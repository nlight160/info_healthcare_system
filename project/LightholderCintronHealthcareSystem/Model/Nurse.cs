...
namespace LightholderCintronHealthcareSystem.Model
{
    ...
    public class Nurse : Person
    {
        ...
        public Nurse(string firstname, string lastname, DateTime birthdate, Address address, string phoneNumber, Gender gender) : base(firstname, lastname, birthdate, address, phoneNumber, gender)
        {
